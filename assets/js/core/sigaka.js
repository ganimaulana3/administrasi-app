			...
			success: function (response) {
				...
				if (response != null){
					html += '' +
						...
						'</div>';
					html += '' +
						'<h2 style="text-align: center">Sekretariat Daerah Provinsi Jawa Barat</h2>' +
...
const divList = document.querySelector('.hidebtn')
...
let div = document.querySelector('hidebtn2');
