...
<head>
    ...
    ================================================== -->
	<meta charset="utf-8">
	<title>Puskodal-Gedung Sate</title>
	...
	<!-- favicons
    ================================================== -->
	<link rel="shortcut icon" href="<?= base_url() ?>assets/images/logo/puskodal2.png" type="image/x-icon">
	<link rel="icon" href="<?= base_url() ?>assets/images/logo/puskodal2.png" type="image/x-icon">
...
<!-- home
================================================== -->
<section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="<?= base_url()?>assets/frontend/images/sigaka/gedung-sate.png" data-natural-width=3000 data-natural-height=2000 data-position-y=top>
	...
	<ul class="home-sidelinks">
		...
		<li><a class="smoothscroll" href="#location">Aktivity<span>what are we doing</span></a></li>
		...
		<div class="col-full">
			...
			<div class="slideshow-container">
				...
				<div class="mySlides fade" style="width: 100%">
					...
					<img src="<?= base_url()?>assets/frontend/images/sigaka/1.jpg" style="width: 100%; height: 650px; margin: 0 auto">
					<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b></b></div>
				</div>

				<div class="mySlides fade" style="width: 100%">
					<div class="numbertext" style="background-color: rgba(0, 0, 0, 0.7)">2 / 10</div>
					<img src="<?= base_url()?>assets/frontend/images/sigaka/2.jpg" style="width: 100%; height: 650px; margin: 0 auto">
					<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b></b></div>
				</div>

				<div class="mySlides fade" style="width: 100%">
					<div class="numbertext" style="background-color: rgba(0, 0, 0, 0.7)">3 / 10</div>
					<img src="<?= base_url()?>assets/frontend/images/sigaka/3.jpg" style="width: 100%; height: 650px; margin: 0 auto">
					<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b></b></div>
				</div>

				<div class="mySlides fade" style="width: 100%">
					<div class="numbertext" style="background-color: rgba(0, 0, 0, 0.7)">4 / 10</div>
					<img src="<?= base_url()?>assets/frontend/images/sigaka/4.jpg" style="width: 100%; height: 650px; margin: 0 auto">
					<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b></b></div>
				</div>

				<div class="mySlides fade" style="width: 100%">
					<div class="numbertext" style="background-color: rgba(0, 0, 0, 0.7)">5 / 10</div>
					<img src="<?= base_url()?>assets/frontend/images/sigaka/5.jpg" style="width: 100%; height: 650px; margin: 0 auto">
					<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b></b></div>
				</div>

				<div class="mySlides fade" style="width: 100%">
					<div class="numbertext" style="background-color: rgba(0, 0, 0, 0.7)">6 / 10</div>
					<img src="<?= base_url()?>assets/frontend/images/sigaka/6.jpg" style="width: 100%; height: 650px; margin: 0 auto">
					<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b></b></div>
				</div>

				<div class="mySlides fade" style="width: 100%">
					<div class="numbertext" style="background-color: rgba(0, 0, 0, 0.7)">7 / 10</div>
					<img src="<?= base_url()?>assets/frontend/images/sigaka/7.jpg" style="width: 100%; height: 650px; margin: 0 auto">
					<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b></b></div>
				</div>

				<div class="mySlides fade" style="width: 100%">
					<div class="numbertext" style="background-color: rgba(0, 0, 0, 0.7)">8 / 10</div>
					<img src="<?= base_url()?>assets/frontend/images/sigaka/8.jpg" style="width: 100%; height: 650px; margin: 0 auto">
					<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b></b></div>
				</div>

				<div class="mySlides fade" style="width: 100%">
					<div class="numbertext" style="background-color: rgba(0, 0, 0, 0.7)">9 / 10</div>
					<img src="<?= base_url()?>assets/frontend/images/sigaka/9.jpg" style="width: 100%; height: 650px; margin: 0 auto">
					<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b></b></div>
				</div>

				<div class="mySlides fade" style="width: 100%">
					<div class="numbertext" style="background-color: rgba(0, 0, 0, 0.7)">10 / 10</div>
					<img src="<?= base_url()?>assets/frontend/images/sigaka/10.jpg" style="width: 100%; height: 650px; margin: 0 auto">
					<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b></b></div>
				</div>
			...
			<div class="masonry__brick" data-aos="fade-up">
				<div class="item-folio">
					...
					<div class="item-folio__thumb">
						<a href="<?=base_url()?>assets/frontend/images/sigaka/11.jpg" class="thumb-link" title="foto absen" data-size="1050x700">
							<img src="<?= base_url()?>assets/frontend/images/sigaka/11.jpg"
								 srcset="<?= base_url()?>assets/frontend/images/sigaka/11.jpg 1x, <?= base_url()?>assets/frontend/images/sigaka/11.jpg 2x" alt="">
						</a>
					</div>
...
<!--			<h1 class="display-1 display-1--light">Get in touch and let's make something great together. Let's turn your idea on an even greater product.</h1>-->
	...
	<div class="row">
		...
		<div class="col-full contact-main" data-aos="fade-up">
			<p>
				<a href="mailto:#0" class="contact-email">maulanag980@gmail.com</a>
				<span class="contact-number">+62 823-1733-0549</span>
			</p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <a href="http://wikidevia.digtive.id/" target="_blank">gani maulana</a>
