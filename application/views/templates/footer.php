...
<footer class="footer footer-static footer-light navbar-border navbar-shadow d-print-none">
    <div class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-block d-md-inline-block">2022  &copy; Copyright <a style="text-decoration:none;" class="text-bold-800 grey darken-2" href="http://tiktok.com/@ganii03_/" target="_blank">gani maulana</a></span>
