	...
	<div class="col-md-12">
		<div class="card box-shadow-2">
			...
			<div class="card-header">
				<h1 style="text-align: center">Detail Data Karyawan</h1>
				...
				<a href="<?=base_url('karyawan')?>" data-toggle="tooltip" data-placement="top" title="kembali" class="btn btn-primary btn-bg-gradient-x-purple-blue box-shadow-2">
					Back <i class="ft-settings spinner"></i>
				</a>
				
				<!--<a href="<?=base_url('edit/update/')?>" data-toggle="tooltip" data-placement="top" title="" class="btn btn-primary btn-bg-gradient-x-purple-blue box-shadow-2">
					update <i class="ft-edit"></i>
				</a>
				<a href="<?=base_url('edit/hapus/')?>" data-toggle="tooltip" data-placement="top" title="" class="btn btn-primary btn-bg-gradient-x-red-pink box-shadow-2">
					hapus <i class="ft-trash"></i>
				</a>-->
			...
			<hr>
			<div class="card-body">
			<a style="position:relative; left:167vh;" href="<?=base_url('edit/update/')?>" data-toggle="tooltip" data-placement="top" title="" class="btn btn-primary btn-bg-gradient-x-purple-blue box-shadow-2">
					update <i class="ft-edit"></i>
				</a>
				<a style="position:relative; left:167vh;" href="<?=base_url('edit/hapus/')?>" data-toggle="tooltip" data-placement="top" title="" class="btn btn-primary btn-bg-gradient-x-red-pink box-shadow-2">
					hapus <i class="ft-trash"></i>
				</a>
				<table class="table table-bordered zero-configuration">
					...
					foreach ($karyawan as $key => $value):
						...
						<tr>
							...
							<button style="color: white; background: rgba(255,255,255,0.00); border: hidden;" class="karyawan-lihat"
