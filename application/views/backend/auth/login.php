...
<div class="app-content content">
	<div class="content-wrapper">
		...
		<span style="position: relative; top:60px;">
			<h1 style="font-family: bold;" class="text-cursive text-red d-block">PUSKODAL APPLICATION</h1>
			<h3 style="font-family: bold;">PUSAT KOMANDO DAN PENGENDALIAN SEKRETARIAT DAERAH PROVINSI</br>JAWA BARAT</h3>
		</span>
		</div>
			<section class="flexbox-container">
				<div class="col-12 d-flex align-items-center justify-content-center">
					<div class="col-lg-4 col-md-6 col-10 box-shadow-2 p-0">
						<!--<div style="text-align:center;">
						<h1 style="font-family: bold;" class="text-cursive h5 text-red d-block">PUSKODAL APPLICATION</h1>
						<h2 style="font-family: bold;">PUSAT KOMANDO DAN PENGENDALIAN GEDUNG SATE</h2>
						</div>-->

						<div class="car border-grey border-lighten-3 px-1 py-1 m-0">
							<div class="car-header border-0">
								<div class="text-center mb-1">
									<img style="width: 200px; position: relative;bottom:15px;" src="<?= base_url() ?>assets/images/logo/puskodal5.png" alt="branding logo">
								</div>
								<div class="font-large-1  text-center" style="color: white; text-shadow: 3px 2px 1px black; font-family: bold; font-style: oblique;">
									LOGIN
								</div>
							</div>
							<div class="card-content">
								<div class="card-body">
									...
									<div class="form-group text-center">
										<button style="font-family: bold;" type="submit"
