	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-header">
				<h1 style="text-align: center">Update Data Jabatan</h1>
			...
			<div class="card-body">
				<table class="table table-bordered zero-configuration" >
					...
					<tr>
						...
						<button class="gaji-edit" data-toggle="modal" style="color: white; background: rgba(255, 255, 255, 0.00); border: hidden; height: 30px;"
									title="Update data" data-target="#ubah" value="<?= $value['jabatan_id'] ?>"><!--<i class="ft-eye"></i>--></button>
						...
						<button class="gaji-edit" data-toggle="modal" style="color: white; background: rgba(255, 255, 255, 0.00); width:100px; height: 30px;border: hidden;"
									title="Update data" data-target="#ubah" value="<?= $value['jabatan_id'] ?>"><!--<i class="ft-eye"></i>--></button>
									<ul class="dropdown-menu">
