	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-header">
				<h1 style="text-align: center">Edit Data Jabatan</h1>

				<a href="<?=base_url('jabatan')?>" data-toggle="tooltip" data-placement="top" title="kembali" class="btn btn-primary btn-bg-gradient-x-purple-blue box-shadow-2">
					Back <i class="ft-settings spinner"></i>
				</a>
				<a href="<?=base_url('jabatan/update2/')?>" data-toggle="tooltip" data-placement="top" title="" class="btn btn-primary btn-bg-gradient-x-purple-blue box-shadow-2">
					update <i class="ft-edit"></i>
				</a>
				<a href="<?=base_url('jabatan/hapus/')?>" data-toggle="tooltip" data-placement="top" title="" class="btn btn-primary btn-bg-gradient-x-red-pink box-shadow-2">
			...
			<div class="card-body">
				<table class="table table-bordered zero-configuration" >
					...
					?>
					<tr>
						<td><div class="btn-group" title="" style="cursor: pointer;"><?=$no?>
						...
						<td><div class="btn-group" title="" style="cursor: pointer;"><?=$value['jabatan_nama']?>
						<!--<li data-bs-toggle="dropdown" style="color: white;"
									title="klik untuk melihat detail"><!--<i class="ft-eye"></i></li>
									<ul class="dropdown-menu">
						...
						<td>Rp. <?=nominal($value['jabatan_gaji'])?><div class="btn-group" title="" style="cursor: pointer;">
						<!--<li data-bs-toggle="dropdown" style="color: white;"
									title="klik untuk melihat detail"><!--<i class="ft-eye"></i></li>
									<ul class="dropdown-menu">
