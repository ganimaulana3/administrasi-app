	...
	<div class="col-md-12">
		<div class="card box-shadow-2">
			...
			<div class="card-header">
				...
				<a href="<?=base_url('edit')?>" data-toggle="tooltip" data-placement="top" title="" class="btn btn-primary btn-bg-gradient-x-purple-blue box-shadow-2">
					Detail <i class="ft-settings spinner"></i>
				</a>
			...
			<div class="card-body">
				...
				<table class="table table-bordered zero-configuration">
					...
					<tr>
						...
						<!--<td><i class="ft-settings spinner"></i></td>-->
					</tr>
					</thead>
					<tbody>
					<?php
