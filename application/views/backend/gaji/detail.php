<div class="row d-print-none">
	<div class="col-md-12">
		<div class="card box-shadow-2">
			...
			<a style="bottom:5px; position:relative;" href="<?=base_url('gaji/index2/')?>" data-toggle="tooltip" data-placement="top" title="kembali" class="btn btn-primary btn-bg-gradient-x-purple-blue box-shadow-2">
					Back <i class="ft-settings spinner"></i>
				</a>

				<!--<button
					class="btn btn-primary btn-bg-gradient-x-purple-blue box-shadow-2 gaji-slip"
					data-toggle="modal" data-target="#slip"
		...
		<div class="modal-content">
			...
			<div class="modal-body ">
				<div class="kotak d-print-block">
					<div class="row">
						<div class="col-12">
							<div class="tengah"><h3><b>Sekretariat Daerah Provinsi Jawa Barat</b></h3></div>
							<div class="tengah">Jln. Diponegoro NO.22, Citarum, Kec. Bandung Wetan, Kota Bandung, Jawa Barat</div>
							<hr>
