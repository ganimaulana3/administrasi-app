	...
	<div class="col-md-12">
		<div class="card box-shadow-2">
			...
			<div class="card-header">
				...
				<a href="<?=base_url('absen/index2/')?>" data-toggle="tooltip" data-placement="top" title="klik untuk melihat detail" class="btn btn-primary btn-bg-gradient-x-purple-blue box-shadow-2">
